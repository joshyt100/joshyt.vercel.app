  ...
  return (
    <div className="min-h-screen bg-zinc-100 dark:bg-zinc-950 dark:text-white px-6 sm:px-10 py-6 overflow-hidden">
      <header className="mb-8">
        <h1 className="text-3xl sm:text-4xl text-center font-normal mt-20 mb-3 tracking-tight">
          {title}
        </h1>
      ...
      <div className="w-full max-w-5xl mx-auto">
        ...
        {/* Main Content */}
        <main className="text-gray-700 dark:text-gray-300 text-wrap leading-relaxed space-y-6">
          {children}
        </main>
      </div>
    </div>
