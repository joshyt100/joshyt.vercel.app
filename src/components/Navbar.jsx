...
const Navbar = ({ theme, toggleTheme }) => {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full sm:h-16 2xl:h-18 bg-transparent border-b  border-gray-500/10 backdrop-blur-xl text-black dark:text-white z-20 flex items-center">
