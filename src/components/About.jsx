...
const About = () => {
  return (
    <div className="bg-zinc-200 dark:bg-zinc-900 min-h-screen flex justify-center">
      ...
      <div className="max-w-6xl w-full flex flex-col lg:flex-row gap-10 items-start">

        {/* Left Section: About Me */}
        <div className="md:w-full lg:w-1/3 w-full  dark:bg-black dark:text-white mt-20 lg:mt-40 bg-white p-8 rounded-lg shadow-md transition-shadow duration-300 hover:shadow-lg">
        ...
        <div className="md:w-2/3 lg:mt-40 w-full">
          ...
          <VerticalTimeline layout="1-column-left">
            ...
            >
              ...
              <ul className="list-disc ml-5 mt-1 text-gray-600 dark:text-gray-300 text-sm">
                ...
                <li>Worked with functional and technical consultants ot develop sofware solutions according to set guidelines</li>
              </ul>
