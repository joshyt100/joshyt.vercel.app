...
const About = ({ theme }) => {
  ...
  return (
    <div className="bg-zinc-50 dark:bg-black min-h-screen flex justify-center">
      ...
      <div className="max-w-6xl lg:max-w-8xl xl:max-w-8xl 2xl:max-w-7xl w-full flex flex-col lg:flex-row lg:gap-10 items-start">
        ...
        <div className="w-full lg:w-5/12 2xl:w-1/3 dark:bg-zinc-900 dark:text-white mt-10 lg:mt-20 2xl:mt-28 bg-white p-8 rounded-lg shadow-md transition-shadow duration-300 hover:shadow-lg">
          <div className="">
            <h2 className="text-2xl sm:text-3xl font-normal mb-6 dark:text-white text-black">About Me</h2>
            ...
            <br />
            <p>             What really draws me into this field is the chance to explore new frameworks and discover creative ways to tackle challenges. I love the process of turning an abstract idea into a concrete solution that people can use and appreciate. It’s incredibly satisfying to see how thoughtful coding and design can simplify tasks and make someone’s day a bit easier</p>
            <br />
            <p>Ultimately, my goal is to keep growing my skill set and work on projects that make a meaningful difference. I’m excited to continue learning, experimenting, and pushing the boundaries of what’s possible in tech.</p>
          </div>
        </div>

        {/* Right Section: Timeline */}
        <div className="w-full lg:w-2/3  lg:mt-20 2xl:mt-28">
          <h2 className="text-3xl font-normal mt-10 lg:mt-0 mb-6 text-center md:text-left text-black dark:text-white">
            Work Experience
          </h2>
