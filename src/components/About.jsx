  ...
  return (
    <div className="bg-zinc-200 dark:bg-zinc-900 min-h-screen flex justify-center">
      ...
      <div className="max-w-6xl w-full flex flex-col lg:flex-row lg:gap-10 items-start">
        ...
        <div className="w-full lg:w-full 2xl:w-1/3 dark:bg-black dark:text-white mt-10 lg:mt-20 2xl:mt-40 bg-white p-8 rounded-lg shadow-md transition-shadow duration-300 hover:shadow-lg">
        ...
        <div className="w-full lg:w-2/3  lg:mt-20 2xl:mt-40">
