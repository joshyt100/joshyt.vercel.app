...
const Contact = () => {
  ...
  return (
    <section
      id="contact"
      className="min-h-screen bg-zinc-100 dark:bg-gradient-to-tl from-zinc-900 to-black text-white flex flex-col items-center justify-center p-8"
    ...
    >
      ...
      >
        ...
        <div className="text-center">
          <button
            type="submit"
            className="w-full bg-black text-white dark:bg-zinc-100 dark:text-black   font-semibold py-2 px-4 rounded-md hover:bg-zinc-700 dark:hover:bg-zinc-200"
          >
            Send Message
          </button>
        </div>
