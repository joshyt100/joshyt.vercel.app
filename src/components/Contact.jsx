  ...
  return (
    ...
    >
      ...
      <form
        ref={formRef}
        onSubmit={sendEmail}
        className="w-full max-w-2xl bg-white dark:bg-zinc-900  z-20 p-6 rounded-lg shadow-2xl space-y-4 border border-zinc-200 dark:border-black"
      >
        <div className="grid grid-cols-1 gap-4">
          <div>
            ...
            <input
              ...
              id="first_name"
              name="first_name"
              className="mt-1 block w-full bg-zinc-100 text-black dark:bg-black opacity-100 rounded-sm dark:text-white focus:border-blue-500 focus:ring-blue-500"
          ...
          <div>
            ...
            <input
              ...
              id="last_name"
              name="last_name"
              className="mt-1 block w-full text-black bg-zinc-100 dark:bg-black opacity-100 rounded-sm dark:text-white focus:border-blue-500 focus:ring-blue-500"
        ...
        <div>
          ...
          <input
            ...
            id="email"
            name="from_email"
            className="mt-1 block w-full rounded-sm bg-zinc-100  dark:bg-black dark:text-gray-300 opacity-100 text-black focus:border-blue-500 focus:ring-blue-500"
        ...
        <div>
          ...
          <textarea
            ...
            name="message"
            rows="4"
            className="mt-1 block w-full rounded-sm bg-zinc-100 dark:bg-black opacity-100 text-black dark:text-gray-300 focus:border-blue-500 focus:ring-blue-500"
